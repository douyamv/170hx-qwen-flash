...
| 3 honor `LLAMA_STATE_SEQ_FLAGS_PARTIAL_ONLY` in the KV cache | `pr/kv-cache-honor-partial-only` | [ggml-org/llama.cpp#28873](https://github.com/ggml-org/llama.cpp/pull/28873) |
| 4 user inputs before cross-device inputs in `compute_splits` | `pr/sched-user-inputs-first` | [ggml-org/llama.cpp#28874](https://github.com/ggml-org/llama.cpp/pull/28874) |
| 5 mmvf for tiny-N F32/F16 weights | `pr/mmvf-tiny-n-f32` | [ggml-org/llama.cpp#28875](https://github.com/ggml-org/llama.cpp/pull/28875) |
