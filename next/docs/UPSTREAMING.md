...
| 4 user inputs before cross-device inputs in `compute_splits` | `pr/sched-user-inputs-first` | opening (GitHub rate-limits PR creation for new accounts; retried automatically) |
